...
#from Quantreo.MetaTrader5 import get_rates
...
def get_rates(symbol, number_of_data=10_000, timeframe=mt5.TIMEFRAME_D1):
    ...
    # Convert a number format of the date into date format
...
df = get_rates("AUDUSD", number_of_data=30000, timeframe=mt5.TIMEFRAME_H4)
